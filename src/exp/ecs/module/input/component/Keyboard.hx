...
class Keyboard implements Component {
	public final isDown:Map<KeyCode, Bool> = new Map();
	public final justDown:Map<KeyCode, Bool> = new Map();
	public final justUp:Map<KeyCode, Bool> = new Map();

	public function clone() {
		return new Keyboard(isDown.copy(), justDown.copy(), justUp.copy());
	}
}

// copied from Kha https://github.com/Kode/Kha/blob/master/Sources/kha/input/KeyCode.hx
@:enum abstract KeyCode(Int) to Int
#if kha from kha.input.KeyCode
#end
{
	var Unknown = 0;
	var Back = 1; // Android
